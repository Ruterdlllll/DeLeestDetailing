...
const I18N = {
  en: {
    ...
    "pricing.note": "All car prices are starting prices — the exact price depends on the size and condition of your vehicle. Motorcycle Detailing has a fixed price. Ask for a no-obligation quote.",
  ...
  nl: {
    ...
    "pricing.note": "Alle autoprijzen zijn vanaf-prijzen — de exacte prijs hangt af van de grootte en staat van je voertuig. Motor Detailing heeft een vaste prijs. Vraag vrijblijvend een offerte aan.",

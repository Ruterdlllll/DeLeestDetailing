...
(e.g. replace `gallery/result-03/01.jpg` with your own `01.jpg`). No code
changes needed — the site picks it up automatically.

Tips for best results:

- Use `.jpg` files, landscape orientation (wider than tall).
